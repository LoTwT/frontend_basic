function mySwiper(selector, imgList) {
...
mySwiper.prototype.renderSwiper = function () {
...
mySwiper.prototype.go = function (i) {
    this.currentImg = i;
    this.renderSwiper()
}


mySwiper.prototype.forward = function () {
    this.currentImg += 1
...
mySwiper.prototype.back = function () {
    this.currentImg -= 1
